            ...
            using (Document report = new Document(PageSize.A4, 40, 40, 40, 40))
            {
                ...
                using (var context = new SalesReportDBContext())
                {
                    ...
                    foreach (var group in groupedByDate)
                    {
                        ...
                        table.AddCell(new PdfPCell(new Phrase("Product", boldFont)) { BackgroundColor = new BaseColor(219, 219, 219), Padding = 2 });
                        table.AddCell(new PdfPCell(new Phrase("Quantity", boldFont)) { BackgroundColor = new BaseColor(219, 219, 219), Padding = 2 });
                        table.AddCell(new PdfPCell(new Phrase("Unit Price", boldFont)) { BackgroundColor = new BaseColor(219, 219, 219), Padding = 2 });
                        table.AddCell(new PdfPCell(new Phrase("Location", boldFont)) { BackgroundColor = new BaseColor(219, 219, 219), Padding = 2 });
                        table.AddCell(new PdfPCell(new Phrase("Sum", boldFont)) { BackgroundColor = new BaseColor(219, 219, 219), Padding = 2 });
